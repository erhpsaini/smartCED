...
public class ChartNumberCrisisPerMonth extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadDataWithBaseURL("file:///android_asset/", buildHtml("2011").toString(), "text/html", "UTF-8", "");
        webView.requestFocusFromTouch();
        setupActionBar();
    }

    private StringBuilder buildHtml(String year){
        List<NumberCrisisPerMonth> numberCrisisPerMonth = db.getNumberCrisisPerMonth(year);
